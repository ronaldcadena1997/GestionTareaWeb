...
var KTContact2Apply = function () {
    ...
    return {
        ...
        init: function () {
            // Elements
            form = document.querySelector('#kt_contact_2_form');
            submitButton = document.getElementById('kt_contact_2_submit_button');

            initForm();
            handleForm();
            initMap('kt_contact_2_map');
        }
    };
}();
